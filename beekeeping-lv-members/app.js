...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Sveiki atbalsta komanda! Man vajadzīga palīdzība saistībā ar Biškopības biedru apgabalu.%0A%0AMans vārds ir: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Sveiki atbalsta komanda! Man vajadzīga palīdzība saistībā ar Biškopības biedru apgabalu.%0A%0AMans vārds ir: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Laipni lūdzam, deputāt</h1><p>Kam jūs šodien vēlētos piekļūt?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">Grāmatas un PDF materiāli</div>
  ...
  // TELA: Grāmatas un PDF materiāli (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digitālā lejupielāde</span>
           </div>
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 <a href="${bk.downloadUrl}" target="_blank" class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: var(--primary); color: #FFF;">
                    <i data-lucide="book-open"></i> Lasiet tūlīt
                 </a>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Jūsu materiāli</h1><p>Pieskarieties tālāk esošajai kolekcijai, lai skatītu tās saturu.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Vēl nav reģistrēti materiāli.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vairāk programmu</h1><p>Drīzumā būs vairāk atjauninājumu!</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Drīzumā būs vairāk atjauninājumu!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Atbalsts</h1><p>Jūsu apmierinātība ir mūsu prioritāte.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopējiet tālāk norādīto adresi un nosūtiet mums e-pastu ar savu jautājumu. Mūsu komanda atbildēs pēc iespējas ātrāk.
             </p>
