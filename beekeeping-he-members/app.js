...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, שלום צוות תמיכה! אני צריך עזרה עם אזור חברי גידול הדבורים שלי.%0A%0Aשמי: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(שלום צוות תמיכה! אני צריך עזרה עם אזור חברי גידול הדבורים שלי.%0A%0Aשמי: ______.)}`;
  }
      ...
      <div class="page-view">
          ...
          <div class="home-grid">
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">מַגָע</div>
  ...
  // TELA: ספרים (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • הורדה דיגיטלית</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>החומרים שלך</h1><p>הקש על אוסף למטה כדי להציג את התוכן שלו.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>עדיין לא נרשמו חומרים.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>תוכניות נוספות</h1><p>גלה חומרים נוספים.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>תְמִיכָה</h1><p>שביעות הרצון שלך היא בראש סדר העדיפויות שלנו.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                העתק את הכתובת למטה ושלח לנו אימייל עם שאלתך. הצוות שלנו יגיב בהקדם האפשרי.
             </p>
