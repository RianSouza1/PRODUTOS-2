...
document.addEventListener("DOMContentLoaded", () => {
          ...
          <div class="home-grid">
            ...
            <a href="#videos" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">I tuoi corsi video</div>
              </div>
            </a>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Support</h1><p>La tua soddisfazione è la nostra priorità.</p></div></div>
