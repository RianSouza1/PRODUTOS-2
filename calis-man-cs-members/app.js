/**
 * APP CORE ENGINE
 * ČLENSKÁ SEKCE (Mobile First & Senior Friendly)
 * Vojenská kalistenika pro muže — Čeština
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initGlobalConfig() {
    if (APP_DATA.config) {
      brandTitle.innerText = APP_DATA.config.brandName || "Vojenská kalistenika pro muže";
    }
  }
  ...
  function handleRouting() {
    ...
    rootEl.insertAdjacentHTML('beforeend', `
       <footer class="app-footer" style="text-align:center; font-size:0.75rem; font-weight: 500; color:#6B7280; padding: 2rem 1rem 1.5rem; letter-spacing: 0.5px;">
         &copy; 2026 ${APP_DATA.config.brandName || "Vojenská kalistenika pro muže"}. Všechna práva vyhrazena.
       </footer>
    `);
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vítej, vážený člene!</h1><p>Ke kterým materiálům chceš dnes přistoupit?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Knihy & materiály v PDF</div>
              </div>
            </a>
            ...
            <a href="#videos" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Tréninková videa & technika</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Pomoc & zákaznický servis</div>
              </div>
            </a>
  ...
  function renderLivros() {
    ...
    const heroCoverImg = (APP_DATA.books && APP_DATA.books[0] && APP_DATA.books[0].coverImage) ? APP_DATA.books[0].coverImage : "assets/covers/man_IMG1_cs.png";
    const heroCoverAlt = (APP_DATA.config && APP_DATA.config.brandName) ? APP_DATA.config.brandName : "Vojenská kalistenika pro muže";

    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Tvoje materiály</h1><p>Klikni na níže uvedené sbírky pro čtení a stažení knih.</p></div></div>
          ...
          <div class="list-container">
            ${featuredHTML || '<p>V tuto chvíli nejsou registrovány žádné materiály.</p>'}
            ${compactHTML}
          </div>
        </div>
      `;
  ...
  function renderVideos() {
    ...
    rootEl.innerHTML = `
      ...
      <div class="playlist-container" style="padding: 24px var(--safe-padding);">
        <div class="hero-card glass-panel" style="margin-top:-24px;"><div class="hero-text"><h1>Tréninková videa</h1><p>Vojenské cviky s vlastní vahou a správná technika pro muže 40+.</p></div></div>
        ...
        <div style="background-color: rgba(16, 185, 129, 0.1); color: var(--primary); border: 1px solid var(--border-light); padding: 12px 16px; border-radius: 8px; margin-bottom: 24px; display: flex; align-items: center; gap: 10px; font-weight: 500; font-size: 0.95rem;" class="glass-panel">
           ...
           <span>Kliknutím na cvik spustíš instruktážní video</span>
        </div>
      ...
      ${isPlaying ? `
              <div class="play-item-body" style="padding: 0 16px 16px 16px; animation: slideDown 0.3s ease;">
                 ...
                 <div style="margin-top: 10px; padding: 10px 14px; background: var(--bg-card); border-radius: 8px; border: 1px solid var(--border-light); font-size: 0.88rem; color: var(--text-muted); display: flex; align-items: center; gap: 8px;">
                     ...
                     <span><strong>Instrukce:</strong> ${vid.obs}</span>
                 </div>
                 ` : ''}
              </div>
            ` : ''}
  ...
  function renderOutrosProdutos() {
      ...
      <div class="premium-book-card">
            ...
            <div class="premium-info">
               ...
               <a href="${prod.linkUrl}" target="_blank" class="premium-btn">
                  <i data-lucide="external-link"></i> ${prod.buttonText || 'Více informací'}
               </a>
            </div>
         </div>
      `;
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Další programy</h1><p>Objev další doporučené průvodce a kurzy.</p></div></div>
          
          <div class="list-container">
            ${prodsHTML || '<p>V tuto chvíli nejsou k dispozici žádné další produkty.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Zákaznická podpora</h1><p>Tvoje spokojenost je naší nejvyšší prioritou.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem; color:var(--text-dark)">Pošli nám zprávu</h3>
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                 Zkopíruj níže uvedenou e-mailovou adresu a pošli nám svůj dotaz. Náš tým podpory ti odpoví co nejdříve.
             </p>
