...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Merhaba destek ekibi! Arıcılık üyeleri alanımla ilgili yardıma ihtiyacım var.%0A%0ABenim adım: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Merhaba destek ekibi! Arıcılık üyeleri alanımla ilgili yardıma ihtiyacım var.%0A%0ABenim adım: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Hoşgeldiniz Üye</h1><p>Bugün neye erişmek istersiniz?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Kitaplar ve PDF Materyalleri</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">TEMAS ETMEK</div>
  ...
  // TELA: KİTAPLAR (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Dijital İndirme</span>
           </div>
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 ...
                 <a href="${bk.downloadUrl}" download class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: transparent; color: var(--text-dark); border: 1px solid var(--border-light);">
                    <i data-lucide="download"></i> PDF'yi indir
                 </a>
              </div>
           </div>
        </div >
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Malzemeleriniz</h1><p>İçeriğini görüntülemek için aşağıdaki bir koleksiyona dokunun.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Henüz kayıtlı malzeme yok.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Daha Fazla Program</h1><p>Ek malzemeleri keşfedin.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Daha fazla güncelleme yakında gelecek!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Destek</h1><p>Memnuniyetiniz bizim önceliğimizdir.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Aşağıdaki adresi kopyalayın ve sorunuzu içeren bir e-postayı bize gönderin. Ekibimiz mümkün olan en kısa sürede yanıt verecektir.
             </p>
