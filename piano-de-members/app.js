/**
 * APP CORE ENGINE
 * MITGLIEDERBEREICH (Mobile First & Senior Friendly)
 * Die komplette Klaviersammlung — Deutsch
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function handleFsUpdate() {
      ...
      document.querySelectorAll('.video-custom-controls').forEach(bar => {
          ...
          if (btn) {
              btn.innerHTML = isFs 
                  ? `<i data-lucide="minimize" style="width: 22px; height: 22px; color: #ffffff;"></i><span>Verkleinern</span>`
                  : `<i data-lucide="maximize" style="width: 22px; height: 22px; color: #ffffff;"></i><span>Vollbild</span>`;
          }
      });
      renderIcons();
  }
  ...
  function initGlobalConfig() {
    if (APP_DATA.config) {
      brandTitle.innerText = APP_DATA.config.brandName || "Die komplette Klaviersammlung";
    }
  }
  ...
  function handleRouting() {
    ...
    rootEl.insertAdjacentHTML('beforeend', `
       <footer class="app-footer" style="text-align:center; font-size:0.75rem; font-weight: 500; color:#6B7280; padding: 2rem 1rem 1.5rem; letter-spacing: 0.5px;">
         &copy; 2026 ${APP_DATA.config.brandName || "Die komplette Klaviersammlung"}. Alle Rechte vorbehalten.
       </footer>
    `);
          ...
          <div class="home-grid">
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Hilfe & Kundenservice</div>
              </div>
            </a>
  ...
  function renderLivros() {
    ...
    const featuredHTML = featuredBooks.map(bk => {
      ...
      <div class="premium-book-card">
            <div class="premium-badge-wrapper">
               ...
               <span class="premium-format">PDF • Downloadbares Dokument</span>
            </div>
    ...
    const heroCoverImg = (APP_DATA.books && APP_DATA.books[0] && APP_DATA.books[0].coverImage) ? APP_DATA.books[0].coverImage : "assets/covers/piano_IMG1_de.png";
    const heroCoverAlt = (APP_DATA.config && APP_DATA.config.brandName) ? APP_DATA.config.brandName : "Die komplette Klaviersammlung";

    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Ihre Materialien</h1><p>Klicken Sie auf die Sammlungen unten, um Ihre Bücher zu lesen und herunterzuladen.</p></div></div>
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Weitere Programme</h1><p>Entdecken Sie weitere empfohlene Ratgeber und Kurse.</p></div></div>
          
          <div class="list-container">
            ${prodsHTML || '<p>Derzeit sind keine weiteren Produkte verfügbar.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Kundenservice & Support</h1><p>Ihre Zufriedenheit steht für uns an erster Stelle.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                 Kopieren Sie die untenstehende E-Mail-Adresse und senden Sie uns Ihre Frage. Unser Support-Team antwortet Ihnen so schnell wie möglich.
             </p>
