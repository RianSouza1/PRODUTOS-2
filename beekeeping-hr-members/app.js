...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Pozdrav timu za podršku! Trebam pomoć oko područja za članove pčelarstva.%0A%0AMoje ime je: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Pozdrav timu za podršku! Trebam pomoć oko područja za članove pčelarstva.%0A%0AMoje ime je: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Dobro došao, član</h1><p>Čemu biste željeli pristupiti danas?</p></div></div>
  ...
  // TELA: KNJIGE (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digitalno preuzimanje</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vaši materijali</h1><p>Dodirnite kolekciju u nastavku da vidite njen sadržaj.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Još nema registriranih materijala.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Više programa</h1><p>Otkrijte dodatne materijale.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Više ažuriranja uskoro!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>podrška</h1><p>Vaše zadovoljstvo naš je prioritet.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopirajte donju adresu i pošaljite nam e-poštu sa svojim pitanjem. Naš tim će odgovoriti u najkraćem mogućem roku.
             </p>
