...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Salutare echipa de suport! Am nevoie de ajutor cu zona mea de membri apicultura.%0A%0ANumele meu este: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Salutare echipa de suport! Am nevoie de ajutor cu zona mea de membri apicultura.%0A%0ANumele meu este: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Bun venit, membru</h1><p>Ce ați dori să accesați astăzi?</p></div></div>
  ...
  // TELA: CĂRȚI (Materiais tipo Bundle)
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Materialele dvs</h1><p>Atingeți o colecție de mai jos pentru a vedea conținutul acesteia.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Nu au fost încă înregistrate materiale.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Mai multe programe</h1><p>Descoperiți materiale suplimentare.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Sprijin</h1><p>Satisfacția dumneavoastră este prioritatea noastră.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Copiați adresa de mai jos și trimiteți-ne un e-mail cu întrebarea dvs. Echipa noastră va răspunde cât mai curând posibil.
             </p>
