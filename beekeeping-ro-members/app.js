...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Materialele tale</h1><p>Atingeți o colecție de mai jos pentru a-i vedea conținutul.</p></div></div>
          
          ${heroCoverHTML}
          
          <div class="list-container">
            ${booksHTML || '<p>Momentan nu sunt înregistrate materiale.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Alte programe</h1><p>Descoperă materiale suplimentare.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Asistență</h1><p>Satisfacția dumneavoastră este prioritatea noastră.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Copiați adresa de mai jos și trimiteți-ne un e-mail cu întrebarea dumneavoastră. Echipa noastră va răspunde în cel mai scurt timp posibil.
             </p>
