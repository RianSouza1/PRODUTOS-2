...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Здравейте екип за поддръжка! Имам нужда от помощ за моята зона за членове на пчеларството.%0A%0AКазвам се: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Здравейте екип за поддръжка! Имам нужда от помощ за моята зона за членове на пчеларството.%0A%0AКазвам се: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Добре дошъл, член</h1><p>До какво бихте искали да получите достъп днес?</p></div></div>
  ...
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Цифрово изтегляне</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Вашите материали</h1><p>Докоснете колекция по-долу, за да видите нейното съдържание.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Все още няма регистрирани материали.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Още програми</h1><p>Открийте допълнителни материали.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Очаквайте скоро още актуализации!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>поддръжка</h1><p>Вашето удовлетворение е наш приоритет.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Копирайте адреса по-долу и ни изпратете имейл с вашия въпрос. Нашият екип ще отговори възможно най-скоро.
             </p>
