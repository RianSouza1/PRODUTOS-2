...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel" style="margin-bottom: 1.5rem;"><div class="hero-text"><h1>I tuoi materiali</h1><p>Accedi ai tuoi manuali e ai bonus qui sotto.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Supporto studenti</h1><p>La tua soddisfazione è la nostra priorità.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Copia l'indirizzo qui sotto e invia un'e-mail con la tua domanda. Il nostro team ti risponderà il prima possibile.
             </p>
