...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel" style="margin-bottom: 1.5rem;"><div class="hero-text"><h1>Vos documents</h1><p>Accédez à vos guides et bonus ci-dessous.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Support étudiant</h1><p>Votre satisfaction est notre priorité.</p></div></div>
