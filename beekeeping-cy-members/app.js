...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Helo tîm cefnogi! Dwi angen help gyda fy ardal aelodau Cadw Gwenyn.%0A%0AFy enw i yw: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Helo tîm cefnogi! Dwi angen help gyda fy ardal aelodau Cadw Gwenyn.%0A%0AFy enw i yw: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Croeso, Aelod</h1><p>Beth hoffech chi gael mynediad iddo heddiw?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">LLYFRAU</div>
                 <div class="home-block-subtitle">Llyfrau a Deunyddiau PDF</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">CYSYLLTIAD</div>
                 <div class="home-block-subtitle">Help and Cefnogaeth</div>
              </div>
            </a>
  ...
  // TELA: LLYFRAU (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Lawrlwytho Digidol</span>
           </div>
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 <a href="${bk.downloadUrl}" target="_blank" class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: var(--primary); color: #FFF;">
                    <i data-lucide="book-open"></i> Darllenwch Nawr
                 </a>
                 <a href="${bk.downloadUrl}" download class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: transparent; color: var(--text-dark); border: 1px solid var(--border-light);">
                    <i data-lucide="download"></i> Lawrlwythwch PDF
                 </a>
              </div>
           </div>
        </div >
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Eich Deunyddiau</h1><p>Tapiwch gasgliad isod i weld ei gynnwys.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Dim deunyddiau wedi'u cofrestru eto.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Mwy o Raglenni</h1><p>Darganfod deunyddiau ychwanegol.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Mwy o ddiweddariadau yn dod yn fuan!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Cefnogaeth</h1><p>Eich boddhad yw ein blaenoriaeth.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem; color:var(--text-dark)">Anfon Neges</h3>
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Copïwch y cyfeiriad isod ac anfonwch e-bost atom gyda'ch cwestiwn. Bydd ein tîm yn ymateb cyn gynted â phosibl.
             </p>
