...
const APP_DATA = {
    config: {
        ...
        emailSubject: "Pitanje o pristupu kursu (Pčelarstvo)",
    ...
    books: [
        {
            ...
            description: "Potpuni vodič za jednostavno i profitabilno pčelarstvo — od postavljanja vaše prve košnice do upravljanja uspješnim pčelinjakom tijekom cijele godine.",
            badgeText: "GLAVNA KNJIGA",
            badgeColor: "#E5A817",
            features: [
                "Kompletan vodič za postavljanje košnice",
                "Sezonski kalendar upravljanja",
                "Profitabilna proizvodnja meda"
            ],
        ...
        },
        {
            ...
            buttonText: "Preuzmite vodič"
        },
        {
            id: "b3",
            title: "Izrada medovine u dvorištu",
            description: "Naučite drevnu umjetnost pravljenja vina od meda kod kuće - korak po korak recepte koristeći svoj vlastiti med.",
            badgeText: "BONUS",
            badgeColor: "#B45309",
            features: [
        ...
        {
            id: "b4",
            title: "Pčelarstvo je jednostavno",
            description: "Pojednostavljeni pristup pčelarenju Marcusa Williamsa — praktični savjeti i trikovi za početnike koji žele brze rezultate.",
            badgeText: "EXTRA",
            badgeColor: "#059669",
            features: [
                "Metode brzog pokretanja",
