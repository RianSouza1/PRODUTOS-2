document.addEventListener('DOMContentLoaded', () => {
  ...
  const setLanguage = (lang) => {
    ...
    document.title = lang === 'pt' 
      ? 'RSCALIBRARY | Organize & Evolua Suas Paixões' 
      : 'RSCALIBRARY | Organize & Evolve Your Passions';

    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', lang === 'pt'
        ? 'RSCALIBRARY LTD — Aplicativos móveis/web e ebooks educacionais de alto nível projetados para ajudar você a organizar, gerenciar e evoluir seus hobbies e paixões.'
        : 'RSCALIBRARY LTD — Premium mobile/web applications and educational ebooks designed to help you organize, manage, and master your favorite hobbies and passions.'
      );
    }
  };
