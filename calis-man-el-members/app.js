 ...
 * Στρατιωτική Καλλισθενική για Άνδρες — Ελληνικά
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initGlobalConfig() {
    if (APP_DATA.config) {
      brandTitle.innerText = APP_DATA.config.brandName || "Στρατιωτική Καλλισθενική για Άνδρες";
    }
  }
  ...
  function handleRouting() {
    ...
    rootEl.insertAdjacentHTML('beforeend', `
       <footer class="app-footer" style="text-align:center; font-size:0.75rem; font-weight: 500; color:#6B7280; padding: 2rem 1rem 1.5rem; letter-spacing: 0.5px;">
         &copy; 2026 ${APP_DATA.config.brandName || "Στρατιωτική Καλλισθενική για Άνδρες"}. Με την επιφύλαξη παντός δικαιώματος.
       </footer>
    `);
          ...
          <div class="home-grid">
            ...
            <a href="#videos" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Βίντεο ασκήσεων & τεχνική εκτέλεσης</div>
              </div>
            </a>
  ...
  function renderLivros() {
    ...
    const heroCoverImg = (APP_DATA.books && APP_DATA.books[0] && APP_DATA.books[0].coverImage) ? APP_DATA.books[0].coverImage : "assets/covers/man_IMG1_el.png";
    const heroCoverAlt = (APP_DATA.config && APP_DATA.config.brandName) ? APP_DATA.config.brandName : "Στρατιωτική Καλλισθενική για Άνδρες";
  ...
  function renderVideos() {
    ...
    rootEl.innerHTML = `
      ...
      <div class="playlist-container" style="padding: 24px var(--safe-padding);">
        <div class="hero-card glass-panel" style="margin-top:-24px;"><div class="hero-text"><h1>Μαθήματα & Ασκήσεις</h1><p>Παρακολουθήστε τα εκπαιδευτικά βίντεο και τις τεχνικές εκτέλεσης</p></div></div>
        ...
        <div style="margin-bottom: 1rem; font-size: 0.9rem; color: var(--text-muted); display: flex; align-items: center; gap: 6px;">
           ...
           <span>Κάντε κλικ σε οποιαδήποτε άσκηση παρακάτω για να ξεκινήσει το βίντεο</span>
        </div>
      ...
      ${isPlaying ? `
              <div class="play-item-body" style="padding: 0 16px 16px 16px; animation: slideDown 0.3s ease;">
                 ...
                 <div style="margin-top: 10px; padding: 10px 14px; background: var(--bg-card); border-radius: 8px; border: 1px solid var(--border-light); font-size: 0.88rem; color: var(--text-muted); display: flex; align-items: center; gap: 8px;">
                     ...
                     <span><strong>Οδηγία:</strong> ${vid.obs}</span>
                 </div>
                 ` : ''}
              </div>
            ` : ''}
