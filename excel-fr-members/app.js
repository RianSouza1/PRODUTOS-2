...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Bienvenue, Membre</h1><p>À quels supports souhaitez-vous accéder aujourd'hui ?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Livres et supports PDF</div>
              </div>
            </a>
            ...
            <a href="#videos" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Vos leçons vidéo</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Aide et support technique</div>
              </div>
            </a>
  ...
  function renderLivros() {
    ...
    if (compactBooks.length > 0) {
      compactHTML = `
      <h2 class="section-divider-title">Livres et ressources complémentaires</h2>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vos Matériaux</h1><p>Cliquez sur un livre ci-dessous pour le consulter et le télécharger.</p></div></div>
          
          <div class="list-container">
            ${featuredHTML || '<p>Aucun matériel n\'est actuellement disponible.</p>'}
            ${compactHTML}
          </div>
        </div>
      `;
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Support Technique</h1><p>Votre satisfaction est notre priorité absolue.</p></div></div>
  ...
  function renderVideos() {
    ...
    rootEl.innerHTML = `
      ...
      <div class="playlist-container" style="padding: 24px var(--safe-padding);">
        <div class="hero-card glass-panel" style="margin-top:-24px;"><div class="hero-text"><h1>Vos Cours Vidéo</h1><p>Découvrez vos leçons exclusives pour maîtriser Excel pas à pas.</p></div></div>
