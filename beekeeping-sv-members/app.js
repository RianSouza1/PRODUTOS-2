...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Välkommen, medlem</h1><p>Vad skulle du vilja ha tillgång till idag?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">KONTAKTA</div>
  ...
  // TELA: BÖCKER (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digital nedladdning</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Ditt material</h1><p>Tryck på en samling nedan för att se dess innehåll.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Inget material registrerat ännu.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Fler program</h1><p>Upptäck ytterligare material.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Stöd</h1><p>Din tillfredsställelse är vår prioritet.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopiera adressen nedan och skicka oss ett mail med din fråga. Vårt team kommer att svara så snart som möjligt.
             </p>
