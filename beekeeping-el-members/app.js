...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Καλώς ορίσατε, Μέλος</h1><p>Σε τι θα θέλατε να αποκτήσετε πρόσβαση σήμερα;</p></div></div>
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Άλλα Προγράμματα</h1><p>Ανακαλύψτε πρόσθετα υλικά.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Υποστήριξη</h1><p>Η ικανοποίησή σας είναι η προτεραιότητά μας.</p></div></div>
