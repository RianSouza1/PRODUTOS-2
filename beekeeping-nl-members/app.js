...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Welkom, lid</h1><p>Waarmee wil je vandaag beginnen?</p></div></div>
  ...
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Uw materialen</h1><p>Tik hieronder op een collectie om de inhoud te bekijken.</p></div></div>
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Andere programma's</h1><p>Ontdek andere materialen.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Binnenkort mais updates!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Ondersteuning</h1><p>Uw tevredenheid is onze prioriteit.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopieer het onderstaande adres en stuur ons een e-mail met uw vraag. Ons team zal zo snel mogelijk antwoorden.
             </p>
