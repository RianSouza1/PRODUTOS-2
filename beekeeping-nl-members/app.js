...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Hallo ondersteuningsteam! Ik heb hulp nodig met mijn ledengedeelte voor de bijenteelt.%0A%0AMijn naam is: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Hallo ondersteuningsteam! Ik heb hulp nodig met mijn ledengedeelte voor de bijenteelt.%0A%0AMijn naam is: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Welkom, lid</h1><p>Waar zou jij vandaag toegang toe willen hebben?</p></div></div>
  ...
  // TELA: BOEKEN (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digitale download</span>
           </div>
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 <a href="${bk.downloadUrl}" target="_blank" class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: var(--primary); color: #FFF;">
                    <i data-lucide="book-open"></i> Lees nu
                 </a>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Jouw materialen</h1><p>Tik hieronder op een verzameling om de inhoud ervan te bekijken.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Nog geen materialen geregistreerd.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Meer programma's</h1><p>Ontdek aanvullende materialen.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Steun</h1><p>Uw tevredenheid is onze prioriteit.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopieer onderstaand adres en stuur ons een e-mail met uw vraag. Ons team zal zo snel mogelijk reageren.
             </p>
