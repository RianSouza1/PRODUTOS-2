...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel" style="margin-bottom: 1.5rem;"><div class="hero-text"><h1>Dine materialer</h1><p>Få tilgang til dine guider og bonuser nedenfor.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Studentsupport</h1><p>Din tilfredshet er vår prioritet.</p></div></div>
