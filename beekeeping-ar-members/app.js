...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, مرحبا فريق الدعم! أحتاج إلى مساعدة في منطقة أعضاء تربية النحل الخاصة بي.%0A%0Aاسمي هو: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(مرحبا فريق الدعم! أحتاج إلى مساعدة في منطقة أعضاء تربية النحل الخاصة بي.%0A%0Aاسمي هو: ______.)}`;
  }
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">الكتب والمواد PDF</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">اتصال</div>
  ...
  // TELA: كتب (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • التحميل الرقمي</span>
           </div>
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 ...
                 <a href="${bk.downloadUrl}" download class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: transparent; color: var(--text-dark); border: 1px solid var(--border-light);">
                    <i data-lucide="download"></i> تحميل قوات الدفاع الشعبي
                 </a>
              </div>
           </div>
        </div >
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>المواد الخاصة بك</h1><p>اضغط على المجموعة أدناه لعرض محتواها.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>لم يتم تسجيل أي مواد حتى الآن.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>المزيد من البرامج</h1><p>اكتشف مواد إضافية.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>المزيد من التحديثات قريبا!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>يدعم</h1><p>رضاكم هو أولويتنا.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem; color:var(--text-dark)">أرسل رسالة</h3>
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                انسخ العنوان أدناه وأرسل لنا بريدًا إلكترونيًا يتضمن سؤالك. سوف يقوم فريقنا بالرد في أقرب وقت ممكن.
             </p>
