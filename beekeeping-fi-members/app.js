...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Hei tukitiimi! Tarvitsen apua mehiläishoidon jäsenalueeni kanssa.%0A%0ANimeni on: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Hei tukitiimi! Tarvitsen apua mehiläishoidon jäsenalueeni kanssa.%0A%0ANimeni on: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Tervetuloa, jäsen</h1><p>Mitä haluaisit käyttää tänään?</p></div></div>
  ...
  // TELA: KIRJAT (Materiais tipo Bundle)
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Sinun materiaalisi</h1><p>Napauta alla olevaa kokoelmaa nähdäksesi sen sisällön.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Materiaalia ei ole vielä rekisteröity.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Lisää ohjelmia</h1><p>Tutustu lisämateriaaleihin.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Tukea</h1><p>Tyytyväisyytesi on meille etusijalla.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopioi alla oleva osoite ja lähetä meille kysymyksesi sähköpostilla. Tiimimme vastaa mahdollisimman pian.
             </p>
