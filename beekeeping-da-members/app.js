...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Hej supportteam! Jeg har brug for hjælp til mit område for biavlsmedlemmer.%0A%0AMit navn er: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Hej supportteam! Jeg har brug for hjælp til mit område for biavlsmedlemmer.%0A%0AMit navn er: ______.)}`;
  }
      ...
      <div class="page-view">
          ...
          <div class="home-grid">
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">KONTAKTE</div>
  ...
  // TELA: BØGER (Materiais tipo Bundle)
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Dine materialer</h1><p>Tryk på en samling nedenfor for at se dens indhold.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Ingen materialer registreret endnu.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Flere programmer</h1><p>Opdag yderligere materialer.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Støtte</h1><p>Din tilfredshed er vores prioritet.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopier nedenstående adresse og send os en mail med dit spørgsmål. Vores team vil svare så hurtigt som muligt.
             </p>
