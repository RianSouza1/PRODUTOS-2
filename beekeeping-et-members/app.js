...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Tere tugimeeskond! Vajan abi oma mesinduse liikmete valdkonnaga.%0A%0AMinu nimi on: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Tere tugimeeskond! Vajan abi oma mesinduse liikmete valdkonnaga.%0A%0AMinu nimi on: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Tere tulemast, liige</h1><p>Millele soovite täna juurde pääseda?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 <div class="home-block-title">RAAMATUD</div>
                 <div class="home-block-subtitle">Raamatud ja PDF-materjalid</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Help and Toetus</div>
              </div>
            </a>
  ...
  // TELA: RAAMATUD (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digitaalne allalaadimine</span>
           </div>
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 <a href="${bk.downloadUrl}" target="_blank" class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: var(--primary); color: #FFF;">
                    <i data-lucide="book-open"></i> Loe kohe
                 </a>
                 <a href="${bk.downloadUrl}" download class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: transparent; color: var(--text-dark); border: 1px solid var(--border-light);">
                    <i data-lucide="download"></i> Laadige alla PDF
                 </a>
              </div>
           </div>
        </div >
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Teie materjalid</h1><p>Puudutage allolevat kogu, et vaadata selle sisu.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Materjale pole veel registreeritud.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Rohkem programme</h1><p>Avastage lisamaterjale.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Rohkem uuendusi peagi tulemas!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Toetus</h1><p>Teie rahulolu on meie prioriteet.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem; color:var(--text-dark)">Saada sõnum</h3>
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopeerige allolev aadress ja saatke meile oma küsimusega e-kiri. Meie meeskond vastab esimesel võimalusel.
             </p>
