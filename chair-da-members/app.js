 ...
 * Stolegymnastik for Seniorer — Dansk
 */
...
document.addEventListener("DOMContentLoaded", () => {
      ...
      document.querySelectorAll('.video-custom-controls').forEach(bar => {
          ...
          if (btn) {
              btn.innerHTML = isFs 
                  ...
                  : `<i data-lucide="maximize" style="width: 22px; height: 22px; color: #ffffff;"></i><span>Fuld skærm</span>`;
          }
      });
      renderIcons();
  }
  ...
  function initGlobalConfig() {
    if (APP_DATA.config) {
      brandTitle.innerText = APP_DATA.config.brandName || "Stolegymnastik for Seniorer";
    }
  }
  ...
  function handleRouting() {
    ...
    rootEl.insertAdjacentHTML('beforeend', `
       <footer class="app-footer" style="text-align:center; font-size:0.75rem; font-weight: 500; color:#94a3b8; padding: 2rem 1rem 1.5rem; letter-spacing: 0.5px;">
         &copy; 2026 ${APP_DATA.config.brandName || "Stolegymnastik for Seniorer"}. Alle rettigheder forbeholdes.
       </footer>
    `);
  ...
  // VISNING: FORSIDE (HOME)
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Velkommen, kære medlem!</h1><p>Hvilke materialer vil du åbne i dag?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Bøger og praktiske vejledninger i PDF</div>
              </div>
            </a>
            ...
            <a href="#contato" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Hjælp og kundeservice</div>
              </div>
            </a>
  ...
  function renderLivros() {
    ...
    if (compactBooks.length > 0) {
      compactHTML = `
      <h2 class="section-divider-title">Yderligere materialer</h2>
    ...
    const heroCoverImg = (APP_DATA.books && APP_DATA.books[0] && APP_DATA.books[0].coverImage) ? APP_DATA.books[0].coverImage : "assets/covers/ch_IMG1_da.png";
    const heroCoverAlt = (APP_DATA.config && APP_DATA.config.brandName) ? APP_DATA.config.brandName : "Stolegymnastik for Seniorer";

    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Dine materialer</h1><p>Klik på samlingerne nedenfor for at læse og downloade dine bøger.</p></div></div>
          ...
          <div class="list-container">
            ${featuredHTML || '<p>Ingen materialer er tilgængelige i øjeblikket.</p>'}
            ${compactHTML}
          </div>
        </div>
      `;
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Flere programmer</h1><p>Oplev flere anbefalede vejledninger og kurser.</p></div></div>
          
          <div class="list-container">
            ${prodsHTML || '<p>Ingen andre produkter er tilgængelige i øjeblikket.</p>'}
          </div>
        </div>
      `;
  }

  // VISNING: KONTAKT / SUPPORT
  function renderContato() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Kundesupport</h1><p>Din tilfredshed er vores højeste prioritet.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <h3 style="font-size: 1.25rem; margin-bottom: 0.5rem; color:var(--text-dark)">Send os en besked</h3>
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                 Kopier e-mailadressen nedenfor og send os dit spørgsmål. Vores supportteam svarer dig så hurtigt som muligt.
             </p>
