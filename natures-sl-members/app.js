...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Podpora študentom</h1><p>Vaše zadovoljstvo je naša prioriteta.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopirajte spodnji naslov in pošljite e-pošto s svojim vprašanjem. Naša ekipa bo odgovorila v najkrajšem možnem času.
             </p>
