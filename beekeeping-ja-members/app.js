...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, こんにちは、サポートチームです！養蜂メンバーエリアについてサポートが必要です。%0A%0A私の名前は： ______。 } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(こんにちは、サポートチームです！養蜂メンバーエリアについてサポートが必要です。%0A%0A私の名前は： ______。)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>ようこそ、メンバー</h1><p>今日は何にアクセスしたいですか?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">書籍と PDF 資料</div>
              </div>
            </a>
  ...
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • デジタルダウンロード</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>あなたの資料</h1><p>下のコレクションをタップして、そのコンテンツを表示します。</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>素材はまだ登録されていません。</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>その他のプログラム</h1><p>追加の資料を発見してください。</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>さらに多くのアップデートが近日公開予定です。</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>サポート</h1><p>お客様の満足が私たちの最優先事項です。</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                以下のアドレスをコピーして、ご質問をメールでお送りください。私たちのチームができるだけ早く対応させていただきます。
             </p>
