...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Добре дошли, член</h1><p>До какво бихте искали да получите достъп днес?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Електронни книги и материали в PDF</div>
              </div>
            </a>
