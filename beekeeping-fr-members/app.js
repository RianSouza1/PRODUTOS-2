...
document.addEventListener("DOMContentLoaded", () => {
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Livres et matériels PDF</div>
              </div>
            </a>
            ...
            <a href="#videos" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Vos cours vidéo</div>
              </div>
            </a>
  ...
  // TELA: LIVRES (Materiais tipo Bundle)
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vos Matériaux</h1><p>Appuyez sur la collection ci-dessous pour voir le contenu.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Aucun matériel enregistré actuellement.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Autres Programmes</h1><p>Découvrez plus de matériaux.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>D'autres nouveautés arrivent bientôt !</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Support</h1><p>Votre satisfaction est notre priorité.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Copiez l'adresse ci-dessous et envoyez-nous un email avec votre question. Notre équipe vous répondra dans les plus brefs délais.
             </p>
  ...
  // ----------------------------------------------------------------------
  // 4. MÓDULO COMPLEXO: RENDERIZADOR DE VIDÉOS
  // ----------------------------------------------------------------------
  function renderVideos() {
    ...
    rootEl.innerHTML = `
      ...
      <div class="playlist-container" style="padding: 24px var(--safe-padding);">
        <div class="hero-card glass-panel" style="margin-top:-24px;"><div class="hero-text"><h1>Vos Cours</h1><p>Restez à jour avec vos cours en ligne</p></div></div>
