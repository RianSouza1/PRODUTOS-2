...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Bienvenue, Membre</h1><p>Que souhaitez-vous consulter aujourd'hui ?</p></div></div>
  ...
  function renderLivros() {
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vos Matériaux</h1><p>Appuyez sur une collection ci-dessous pour voir le contenu.</p></div></div>
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          ...
          <div class="list-container">
            ${prodsHTML || '<p>Plus de nouvelles bientôt !</p>'}
          </div>
        </div>
      `;
  }
      ...
      <div class="page-view">
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Copiez l'adresse ci-dessous et envoyez-nous un e-mail avec votre question. Notre équipe vous répondra dès que possible.
             </p>
  ...
  function renderVideos() {
    ...
    rootEl.innerHTML = `
      ...
      <div class="playlist-container" style="padding: 24px var(--safe-padding);">
        <div class="hero-card glass-panel" style="margin-top:-24px;"><div class="hero-text"><h1>Vos Cours</h1><p>Suivez vos cours en ligne</p></div></div>
