...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Hello support team! I need help with my Beekeeping members area.%0A%0AMy name is: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Hello support team! I need help with my Beekeeping members area.%0A%0AMy name is: ______.)}`;
  }
