...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Hei supportteam! Jeg trenger hjelp med birøktmedlemsområdet mitt.%0A%0AMitt navn er: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Hei supportteam! Jeg trenger hjelp med birøktmedlemsområdet mitt.%0A%0AMitt navn er: ______.)}`;
  }
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Bøker og PDF-materiale</div>
              </div>
            </a>
  ...
  // TELA: BØKER (Materiais tipo Bundle)
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digital nedlasting</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Materialet ditt</h1><p>Trykk på en samling nedenfor for å se innholdet.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Ingen materiell registrert ennå.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Flere programmer</h1><p>Oppdag ytterligere materialer.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Støtte</h1><p>Din tilfredshet er vår prioritet.</p></div></div>
