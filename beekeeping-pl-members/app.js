...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Witaj zespół wsparcia! Potrzebuję pomocy w obszarze członków pszczelarstwa.%0A%0ANazywam się: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Witaj zespół wsparcia! Potrzebuję pomocy w obszarze członków pszczelarstwa.%0A%0ANazywam się: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Witamy, Członku</h1><p>Do czego chciałbyś dzisiaj uzyskać dostęp?</p></div></div>
  ...
  // TELA: KSIĄŻKI (Materiais tipo Bundle)
  function renderLivros() {
           ...
           <div class="premium-info">
              ...
              <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%; margin-top: 1.5rem;">
                 <a href="${bk.downloadUrl}" target="_blank" class="premium-btn" style="width: 100%; text-align: center; justify-content: center; background: var(--primary); color: #FFF;">
                    <i data-lucide="book-open"></i> Przeczytaj teraz
                 </a>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Twoje materiały</h1><p>Kliknij kolekcję poniżej, aby wyświetlić jej zawartość.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Nie zarejestrowano jeszcze żadnych materiałów.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Więcej programów</h1><p>Odkryj dodatkowe materiały.</p></div></div>
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Wsparcie</h1><p>Twoje zadowolenie jest naszym priorytetem.</p></div></div>
