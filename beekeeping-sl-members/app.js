...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function mountMailTo() {
    const { contactEmail, emailSubject, Pozdravljena ekipa za podporo! Potrebujem pomoč pri članskem delu čebelarstva.%0A%0AMoje ime je: ______. } = APP_DATA.config;
    return `mailto:${contactEmail}?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(Pozdravljena ekipa za podporo! Potrebujem pomoč pri članskem delu čebelarstva.%0A%0AMoje ime je: ______.)}`;
  }
  ...
  function renderHome() {
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Dobrodošli, član</h1><p>Do česa bi radi dostopali danes?</p></div></div>
          ...
          <div class="home-grid">
            ...
            <a href="#livros" class="home-block glass-panel">
              ...
              <div>
                 ...
                 <div class="home-block-subtitle">Knjige in gradiva PDF</div>
              </div>
            </a>
  ...
  function renderLivros() {
    const booksHTML = APP_DATA.books.map(bk => {
      ...
      <div class="premium-book-card">
           <div class="premium-badge-wrapper">
              ...
              <span class="premium-format">PDF • Digitalni prenos</span>
           </div>
    ...
    rootEl.innerHTML = `
      <div class="page-view" style="padding-bottom: 0;">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Vaši materiali</h1><p>Tapnite zbirko spodaj, da si ogledate njeno vsebino.</p></div></div>
          
          
          <div class="list-container">
            ${booksHTML || '<p>Ni registriranih materialov.</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderOutrosProdutos() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Več programov</h1><p>Odkrijte dodatne materiale.</p></div></div>
          
          
          <div class="list-container">
            ${prodsHTML || '<p>Več posodobitev kmalu!</p>'}
          </div>
        </div>
      `;
  }
  ...
  function renderContato() {
    ...
    rootEl.innerHTML = `
      <div class="page-view">
          <div class="hero-card glass-panel"><div class="hero-text"><h1>Podpora</h1><p>Vaše zadovoljstvo je naša prioriteta.</p></div></div>
          ...
          <div class="card-bloco glass-panel" style="text-align: center; padding: 2.5rem 1.5rem;">
             ...
             <p style="font-size: 0.95rem; color: var(--text-muted); margin-bottom: 2rem; line-height:1.5;">
                Kopirajte spodnji naslov in nam pošljite e-pošto s svojim vprašanjem. Naša ekipa se bo odzvala v najkrajšem možnem času.
             </p>
